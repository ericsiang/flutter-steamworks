...
extension ISteamUserExtensions on Pointer<ISteamUser> {
  ...
  EVoiceResult getAvailableVoice(
    ...
    int nUncompressedVoiceDesiredSampleRateDeprecated,
      ...
      EVoiceResult.fromValue(_getAvailableVoice.call(
        this,
        pcbCompressed,
  ...
  EVoiceResult getVoice(
    ...
    int nUncompressedVoiceDesiredSampleRateDeprecated,
      ...
      EVoiceResult.fromValue(_getVoice.call(
        this,
        wantCompressed,
        pDestBuffer,
        cbDestBufferSize,
  ...
  EVoiceResult decompressVoice(
    ...
    int nDesiredSampleRate,
      ...
      EVoiceResult.fromValue(_decompressVoice.call(
        this,
        pCompressed,
        cbCompressed,
        pDestBuffer,
  ...
  EBeginAuthSessionResult beginAuthSession(
    ...
    CSteamId steamId,
      ...
      EBeginAuthSessionResult.fromValue(_beginAuthSession.call(
        this,
        pAuthTicket,
        cbAuthTicket,
        steamId,
  ...
  EUserHasLicenseForAppResult userHasLicenseForApp(
    ...
    AppId appId,
      ...
      EUserHasLicenseForAppResult.fromValue(_userHasLicenseForApp.call(
        this,
        steamId,
        appId,
      ));
