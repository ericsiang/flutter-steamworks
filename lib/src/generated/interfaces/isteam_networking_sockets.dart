...
extension ISteamNetworkingSocketsExtensions
  ...
  EResult acceptConnection(
    HSteamNetConnection hConn,
      ...
      EResult.fromValue(_acceptConnection.call(
        this,
        hConn,
      ));
  ...
  EResult sendMessageToConnection(
    ...
    Pointer<LongLong> pOutMessageNumber,
      ...
      EResult.fromValue(_sendMessageToConnection.call(
        this,
        hConn,
        pData,
        cbData,
  ...
  EResult flushMessagesOnConnection(
    HSteamNetConnection hConn,
      ...
      EResult.fromValue(_flushMessagesOnConnection.call(
        this,
        hConn,
      ));
  ...
  EResult getConnectionRealTimeStatus(
    ...
    Pointer<SteamNetConnectionRealTimeLaneStatus> pLanes,
      ...
      EResult.fromValue(_getConnectionRealTimeStatus.call(
        this,
        hConn,
        pStatus,
        nLanes,
  ...
  EResult configureConnectionLanes(
    ...
    Pointer<UnsignedShort> pLaneWeights,
      ...
      EResult.fromValue(_configureConnectionLanes.call(
        this,
        hConn,
        nNumLanes,
        pLanePriorities,
  ...
  ESteamNetworkingAvailability initAuthentication() =>
      ESteamNetworkingAvailability.fromValue(_initAuthentication.call(
        this,
      ));
  ...
  ESteamNetworkingAvailability getAuthenticationStatus(
    Pointer<SteamNetAuthenticationStatus> pDetails,
      ...
      ESteamNetworkingAvailability.fromValue(_getAuthenticationStatus.call(
        this,
        pDetails,
      ));
  ...
  EResult getHostedDedicatedServerAddress(
    Pointer<SteamDatagramHostedAddress> pRouting,
      ...
      EResult.fromValue(_getHostedDedicatedServerAddress.call(
        this,
        pRouting,
      ));
  ...
  EResult getGameCoordinatorServerLogin(
    ...
    Pointer<Void> pBlob,
      ...
      EResult.fromValue(_getGameCoordinatorServerLogin.call(
        this,
        pLoginInfo,
        pcbSignedBlob,
        pBlob,
  ...
  EResult getRemoteFakeIpForConnection(
    ...
    Pointer<SteamNetworkingIpAddr> pOutAddr,
      ...
      EResult.fromValue(_getRemoteFakeIpForConnection.call(
        this,
        hConn,
        pOutAddr,
      ));
