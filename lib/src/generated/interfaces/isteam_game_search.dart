...
extension ISteamGameSearchExtensions on Pointer<ISteamGameSearch> {
  EGameSearchErrorCode addGameSearchParams(
    ...
    Pointer<Utf8> valuesToFind,
      ...
      EGameSearchErrorCode.fromValue(_addGameSearchParams.call(
        this,
        keyToFind,
        valuesToFind,
      ));
  ...
  EGameSearchErrorCode searchForGameWithLobby(
    ...
    int nPlayerMax,
      ...
      EGameSearchErrorCode.fromValue(_searchForGameWithLobby.call(
        this,
        steamIdLobby,
        nPlayerMin,
        nPlayerMax,
  ...
  EGameSearchErrorCode searchForGameSolo(
    ...
    int nPlayerMax,
      ...
      EGameSearchErrorCode.fromValue(_searchForGameSolo.call(
        this,
        nPlayerMin,
        nPlayerMax,
      ));

  EGameSearchErrorCode acceptGame() =>
      EGameSearchErrorCode.fromValue(_acceptGame.call(
        this,
      ));

  EGameSearchErrorCode declineGame() =>
      EGameSearchErrorCode.fromValue(_declineGame.call(
        this,
      ));
  ...
  EGameSearchErrorCode retrieveConnectionDetails(
    ...
    int cubConnectionDetails,
      ...
      EGameSearchErrorCode.fromValue(_retrieveConnectionDetails.call(
        this,
        steamIdHost,
        connectionDetails,
  ...
  EGameSearchErrorCode endGameSearch() =>
      EGameSearchErrorCode.fromValue(_endGameSearch.call(
        this,
      ));
  ...
  EGameSearchErrorCode setGameHostParams(
    ...
    Pointer<Utf8> value,
      ...
      EGameSearchErrorCode.fromValue(_setGameHostParams.call(
        this,
        key,
        value,
      ));
  ...
  EGameSearchErrorCode setConnectionDetails(
    ...
    int cubConnectionDetails,
      ...
      EGameSearchErrorCode.fromValue(_setConnectionDetails.call(
        this,
        connectionDetails,
        cubConnectionDetails,
      ));
  ...
  EGameSearchErrorCode requestPlayersForGame(
    ...
    int nMaxTeamSize,
      ...
      EGameSearchErrorCode.fromValue(_requestPlayersForGame.call(
        this,
        nPlayerMin,
        nPlayerMax,
        nMaxTeamSize,
  ...
  EGameSearchErrorCode hostConfirmGameStart(
    int uniqueGameId,
      ...
      EGameSearchErrorCode.fromValue(_hostConfirmGameStart.call(
        this,
        uniqueGameId,
      ));

  EGameSearchErrorCode cancelRequestPlayersForGame() =>
      EGameSearchErrorCode.fromValue(_cancelRequestPlayersForGame.call(
        this,
      ));
  ...
  EGameSearchErrorCode submitPlayerResult(
    ...
    EPlayerResult ePlayerResult,
      ...
      EGameSearchErrorCode.fromValue(_submitPlayerResult.call(
        this,
        uniqueGameId,
        steamIdPlayer,
        ePlayerResult.value,
  ...
  EGameSearchErrorCode endGame(
    int uniqueGameId,
      ...
      EGameSearchErrorCode.fromValue(_endGame.call(
        this,
        uniqueGameId,
      ));
}
