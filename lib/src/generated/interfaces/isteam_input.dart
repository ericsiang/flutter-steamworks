...
extension ISteamInputExtensions on Pointer<ISteamInput> {
  ...
  ESteamInputType getInputTypeForHandle(
    InputHandle inputHandle,
      ...
      ESteamInputType.fromValue(_getInputTypeForHandle.call(
        this,
        inputHandle,
      ));
  ...
  EInputActionOrigin getActionOriginFromXboxOrigin(
    ...
    EXboxOrigin origin,
      ...
      EInputActionOrigin.fromValue(_getActionOriginFromXboxOrigin.call(
        this,
        inputHandle,
        origin.value,
      ));
  ...
  EInputActionOrigin translateActionOrigin(
    ...
    EInputActionOrigin sourceOrigin,
      ...
      EInputActionOrigin.fromValue(_translateActionOrigin.call(
        this,
