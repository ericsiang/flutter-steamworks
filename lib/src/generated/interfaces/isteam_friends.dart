...
extension ISteamFriendsExtensions on Pointer<ISteamFriends> {
  ...
  EPersonaState getPersonaState() =>
      EPersonaState.fromValue(_getPersonaState.call(
        this,
      ));
  ...
  EFriendRelationship getFriendRelationship(
    CSteamId steamIdFriend,
      ...
      EFriendRelationship.fromValue(_getFriendRelationship.call(
        this,
        steamIdFriend,
      ));
  ...
  EPersonaState getFriendPersonaState(
    CSteamId steamIdFriend,
      ...
      EPersonaState.fromValue(_getFriendPersonaState.call(
        this,
        steamIdFriend,
      ));
